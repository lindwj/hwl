                        ...
                        if(pageField!=null){  
                        	...
                        	if(parameterObject instanceof HashMap){
                        		...
                        		while (iter.hasNext()) {
                        		  ...
                        		  if(val!=null&&ReflectHelper.getFieldByFieldName(val, "page")!=null){
                        			  c=val;
                        			  break;
                        		  }
                        		}        
                        		if(c!=null){
                        		page=(Page)ReflectHelper.getValueByFieldName(c,"page");
                        		if(page==null){
                        			 page = new Page();  
                        		}
                        		page.setEntityOrField(false); //见com.flf.entity.Page.entityOrField 注释  
                                page.setTotalResult(count);                                  
                                	ReflectHelper.setValueByFieldName(c,"page", page); //通过反射，对实体对象设置分页对象
                                }else{
        ...
        if (parameterMappings != null) {  
            ...
            for (int i = 0; i < parameterMappings.size(); i++) {  
                ...
                if (parameterMapping.getMode() != ParameterMode.OUT) {  
                    ...
                    System.out.println(ps.toString()+":"+value+":"+parameterMapping.getJdbcType());
